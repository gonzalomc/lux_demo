...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Ot.client'
        db.add_column('ot', 'client',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='client', to=orm['webapp.Client']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Ot.client'
        db.delete_column('ot', 'client_id')
    ...
    models = {
        ...
        'webapp.ot': {
            ...
            'client': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'client'", 'to': "orm['webapp.Client']"}),
