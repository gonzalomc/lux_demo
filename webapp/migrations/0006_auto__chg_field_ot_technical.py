...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Ot.technical'
        db.alter_column('ot', 'technical_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['webapp.Technical']))

    def backwards(self, orm):

        # Changing field 'Ot.technical'
        db.alter_column('ot', 'technical_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['webapp.Technical']))
    ...
    models = {
        ...
        'webapp.ot': {
            ...
            'technical': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'technical'", 'null': 'True', 'to': "orm['webapp.Technical']"})
        },
        'webapp.otimage': {
