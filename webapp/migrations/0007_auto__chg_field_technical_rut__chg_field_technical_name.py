...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Technical.rut'
        db.alter_column('technical', 'rut', self.gf('django.db.models.fields.CharField')(default='16.200.488-3', max_length=15))

        # Changing field 'Technical.name'
        db.alter_column('technical', 'name', self.gf('django.db.models.fields.CharField')(default='gonzalo', max_length=100))

    def backwards(self, orm):

        # Changing field 'Technical.rut'
        db.alter_column('technical', 'rut', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))

        # Changing field 'Technical.name'
        db.alter_column('technical', 'name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
